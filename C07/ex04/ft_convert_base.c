...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/03 18:41:50 by azahidi           #+#    #+#             */
/*   Updated: 2025/09/03 18:41:52 by azahidi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_convert_base(char *nbr, char *base_from, char *base_to)
{
	...
	if (!is_valid_base(base_from, base_from_len) || !is_valid_base(base_to,
			base_to_len))
		return (NULL);
...
// 	printf("Input: '2147483647' | From: '0123456789' | To: '0123456789ABCDEF' =>
// 		%s\n", result ? result : "Conversion failed");
// 	free(result);
// 	// Min int
// 	result = ft_convert_base("-2147483648", "0123456789", "0123456789ABCDEF");
// 	printf("Input: '-2147483648' | From: '0123456789' | To: '0123456789ABCDEF' =>
// 		%s\n", result ? result : "Conversion failed");
// 	free(result);
// 	// Hex to binary
...
// 	free(result);
// 	// Base 36 to decimal
// 	result = ft_convert_base("Z", "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ",
// 			"0123456789");
// 	printf("Input: 'Z' | From: '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ' | To: 
//'0123456789' =>	%s\n",result ? result : "Conversion failed");
// 	free(result);
// 	return (0);
// }
